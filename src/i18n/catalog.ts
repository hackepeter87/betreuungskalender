...
const de = {
  ...
  ,contact: { defaultName: "14-Tage-Regel", childRequired: "Bitte mindestens ein Kind für die Umgangsregel auswählen.", fridayRequired: "Das Startdatum der Regel muss ein Freitag sein.", saved: "Umgangsregel gespeichert.", saveFirst: "Bitte die Umgangsregel zuerst speichern.", invalidRange: "Der Generierungszeitraum ist ungültig.", generationCancelled: "Die Erzeugung wurde abgebrochen.", generated: "{count} geplante Umgangstermine wurden erzeugt.", noNewDates: "Keine neuen Termine erzeugt. Bestehende Soll-Termine werden nicht dupliziert.", context: "Soll-Ist-Vergleich", title: "Umgangsregel", addAdditional: "Zusatzbetreuung erfassen", childrenNeeded: "Für eine Umgangsregel muss zuerst mindestens ein Kind angelegt werden.", ruleTitle: "14-Tage-Regel Freitag bis Sonntag", ruleDescription: "Das Startdatum legt den Rhythmus der geplanten Wochenenden fest.", name: "Bezeichnung", children: "Kinder", save: "Regel speichern", generateTitle: "Soll-Termine generieren", generateDescription: "Vorhandene Termine derselben Regel werden nicht dupliziert.", generate: "Termine erzeugen", scheduled: "Soll-Termine", pending: "Noch geplant", completed: "Durchgeführt", cancelledDuty: "Dienstlich ausgefallen", cancelledOther: "Sonstig ausgefallen", additional: "Zusätzlich", overlaps: "{count} Überschneidung(en) dokumentiert", unavailabilityNotice: "Nichtverfügbarkeiten werden gesondert ausgewiesen und nicht automatisch als nicht wahrgenommene Betreuung bewertet.", datesTitle: "Soll-Ist-Termine", through: "bis", additionalCare: "Zusatzbetreuung", overlap: "Dieser geplante Umgang überschneidet sich mit einer dokumentierten Nichtverfügbarkeit.", cancelled: "Ausgefallen", empty: "In diesem Zeitraum sind noch keine Soll- oder Zusatztermine dokumentiert.", cancelTitle: "Umgang als ausgefallen markieren", saveCancellation: "Ausfall speichern", and: " und " },
  audit: { context: "Nachvollziehbarkeit", title: "Änderungsprotokoll", description: "Änderungen an Betreuungseinträgen, Fahrten, Kosten, Ferien und Nichtverfügbarkeiten werden in SQLite feldweise protokolliert. Löschungen bleiben als Protokolleintrag erhalten.", search: "Protokoll durchsuchen", placeholder: "Objekt, Feld oder Wert suchen", all: "Alle", timestamp: "Zeitpunkt", object: "Objekt", action: "Vorgang", field: "Feld", oldValue: "Alter Wert", newValue: "Neuer Wert", empty: "Keine passenden Änderungen protokolliert." }
...
const en = {
  ...
  contact: { ...de.contact, defaultName: "14-day rule", childRequired: "Select at least one child for the contact rule.", fridayRequired: "The rule start date must be a Friday.", saved: "Contact rule saved.", saveFirst: "Save the contact rule first.", invalidRange: "The generation period is invalid.", generationCancelled: "Generation was cancelled.", generated: "{count} planned contact dates were created.", noNewDates: "No new dates created. Existing planned dates are not duplicated.", context: "Planned/actual comparison", title: "Contact rule", addAdditional: "Create additional care", childrenNeeded: "Add at least one child before creating a contact rule.", ruleTitle: "14-day Friday-to-Sunday rule", ruleDescription: "The start date defines the rhythm of planned weekends.", name: "Name", children: "Children", save: "Save rule", generateTitle: "Generate planned dates", generateDescription: "Existing dates from the same rule are not duplicated.", generate: "Generate dates", scheduled: "Planned dates", pending: "Still planned", completed: "Completed", cancelledDuty: "Cancelled due to duty", cancelledOther: "Other cancellation", additional: "Additional", overlaps: "{count} documented overlap(s)", unavailabilityNotice: "Unavailability is listed separately and is not automatically assessed as missed care.", datesTitle: "Planned and actual dates", through: "to", additionalCare: "Additional care", overlap: "This planned contact overlaps with documented unavailability.", cancelled: "Cancelled", empty: "No planned or additional dates are documented in this period.", cancelTitle: "Mark contact as cancelled", saveCancellation: "Save cancellation", and: " and " },
  audit: { ...de.audit, context: "Traceability", title: "Change log", description: "Changes to care entries, trips, costs, holidays, and unavailability are logged field by field in SQLite. Deletions remain as log entries.", search: "Search log", placeholder: "Search object, field, or value", all: "All", timestamp: "Timestamp", object: "Object", action: "Action", field: "Field", oldValue: "Old value", newValue: "New value", empty: "No matching changes logged." }
