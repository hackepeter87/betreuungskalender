...
Replace `X.Y.Z` with the package version, for example `1.5.0`, and `vX.Y.Z`
with the matching release tag, for example `v1.5.0`.
...
Use `v1.0.0` or a newer verified release artifact for normal production OIDC
