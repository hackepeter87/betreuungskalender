...
const en = {
  ...
  confirmation: { ...de.confirmation, title: "Open confirmations", description: "Confirm past planned care dates so reports can distinguish planned and actual care.", completed: "Yes, completed", cancelled: "No, cancelled", partial: "Partially completed", remindLater: "Remind later", notePlaceholder: "Optional short factual note", dueYesterday: "Confirm planned care after the date", partialDetails: "Record partial completion", actualChildren: "Which children actually participated?", actualStart: "Actual start", actualStartTime: "Start time", actualEnd: "Actual end", actualEndTime: "End time", actualCareParty: "Actual care party", notificationCenter: "Notifications", notificationCenterDescription: "Open confirmations and reminders", notificationCenterAria: "Open notifications, {count} open", moreOpen: "{count} more open confirmation(s)", nextReminder: "Next reminder: {date}", reminderCount: "{count} reminder(s) scheduled", empty: "No open confirmations." },
